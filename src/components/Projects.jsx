...
const Projects = () => {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="mt-20 pl-0 p-5 lg:pl-[13%] flex flex-wrap gap-12 items-center justify-start">
        {projects.map((project) => (
          <div className="relative rounded-2xl sm:w-[360px] w-full h-fit p-4" key={project.name}>
            <img src={project.image} alt="" className="w-full h-[60%] rounded-2xl" />
